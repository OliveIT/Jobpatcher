            ...
            <table className="gx-dashboard-overall-table gx-customer-panel-table">
                <thead>
                    <tr>
                        ...
                        <th><IntlMessages id="dashboard.overall.table.due"/></th>
                        <th><IntlMessages id="dashboard.overall.table.amount"/></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        data.map( (item, index) => 
                            <tr key={index}>
                                ...
                                <td className="gx-text-right">
                                    <Button className="gx-customized-button gx-customized-text-button"><IntlMessages id="dashboard.overall.table.resend"/></Button>                                       
                                </td>
                            </tr>
                        )
                    }
